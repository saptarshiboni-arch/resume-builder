...
export default function LandingPage({ onStartResume, onLoadDemo }) {
  ...
  return (
    <div className="relative overflow-hidden pt-6 pb-16">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-indigo-100/60 via-purple-50/40 to-transparent pointer-events-none -z-10 blur-3xl" />
      <div className="absolute top-20 right-10 w-72 h-72 bg-indigo-300/20 rounded-full blur-3xl -z-10" />
      <div className="absolute top-40 left-10 w-72 h-72 bg-purple-300/20 rounded-full blur-3xl -z-10" />
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8 sm:pt-14 pb-12">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-indigo-200/80 shadow-sm text-xs font-semibold text-indigo-700 mb-6"
        >
        ...
        >
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm sm:text-base text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 shadow-sm transition-all"
          >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-12">
        <div className="text-center mb-8">
          <h2 className="text-xs uppercase font-extrabold tracking-widest text-indigo-600">Built for Modern Job Seekers</h2>
          <p className="text-xl sm:text-2xl font-bold text-slate-900 mt-1 font-display">Everything you need to stand out</p>
        </div>
          ...
          {features.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-sm hover:shadow-md hover:border-indigo-200 transition-all group"
              >
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-14 sm:mt-20">
        <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-6 sm:p-10 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6">
              <div className="bg-white/95 rounded-2xl p-5 text-slate-800 shadow-2xl text-xs space-y-3 transform lg:rotate-1 hover:rotate-0 transition-transform duration-300">
                <div className="flex items-center justify-between border-b border-slate-200 pb-2">
                  <div>
                    <span className="font-bold text-slate-900 text-sm">Alex Johnson</span>
                    <p className="text-[10px] text-indigo-600 font-semibold">Full Stack Developer</p>
                  </div>
                  <span className="text-[9px] px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 font-bold border border-emerald-200">
                    Quality: 92/100
                  </span>
                </div>

                <div>
                  <span className="font-bold text-[10px] uppercase text-indigo-900 tracking-wider">AI Polished Summary</span>
                  <p className="text-[11px] text-slate-600 mt-0.5 leading-relaxed italic bg-indigo-50/50 p-2 rounded border border-indigo-100">
                ...
                <div>
                  <span className="font-bold text-[10px] uppercase text-indigo-900 tracking-wider">Skills</span>
