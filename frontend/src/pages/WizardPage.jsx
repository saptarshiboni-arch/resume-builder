        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 1 && (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-slate-200/80 p-6 sm:p-8 shadow-sm space-y-6"
            >
              <div className="border-b border-slate-100 pb-4">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 font-display">Personal Information</h2>
                <p className="text-xs text-slate-500 mt-1">Let recruiters know who you are and how to reach you.</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-slate-700 mb-1">
                    Portfolio / Website URL <span className="text-slate-400 font-normal">(Optional)</span>
                  </label>
                  <input
                    type="url"
          ...
          {currentStep === 2 && (
            ...
            >
              <div className="border-b border-slate-100 pb-4">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 font-display">Career Goal & Target Role</h2>
                <p className="text-xs text-slate-500 mt-1">This helps the AI tailor the executive summary and tone for your exact goal.</p>
              </div>
                ...
                {formData.career.targetRole === 'Other' && (
                  <div className="mt-3">
                    <input
                      ...
                      className="w-full px-3.5 py-2 text-sm rounded-xl border border-indigo-300 focus:ring-2 focus:ring-indigo-500 outline-none"
                    />
                  </div>
                )}
            ...
            >
              <div className="border-b border-slate-100 pb-4 flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-900 font-display">Education</h2>
                  <p className="text-xs text-slate-500 mt-1">Add your highest degree and schooling credentials.</p>
                </div>
                <button
                  type="button"
                ...
                <div className="space-y-6">
                  {formData.education.map((edu, idx) => {
                    ...
                    return (
                      <div
                        key={edu.id || idx}
                        className="p-5 rounded-2xl border border-slate-200 bg-slate-50/50 relative space-y-4"
                      >
                        <div className="flex items-center justify-between">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                          {isSchool ? (
                            <>
                              ...
                              <div>
                                <label className="block text-xs font-semibold text-slate-700 mb-1">Stream / Board</label>
                                <input
                                  type="text"
                                  value={edu.field || ''}
                            ...
                            <>
                              ...
                              <div>
                                <label className="block text-xs font-semibold text-slate-700 mb-1">Field / Major</label>
                                <input
                                  type="text"
                                  value={edu.field || ''}
                                  onChange={(e) => updateEducation(idx, 'field', e.target.value)}
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-slate-700 mb-1">GPA / Percentage</label>
                            <input
                              type="text"
                              value={edu.score || ''}
          ...
          {currentStep === 4 && (
            ...
            >
              <div className="border-b border-slate-100 pb-4">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 font-display">Technical Skills & Tools</h2>
                <p className="text-xs text-slate-500 mt-1">
                  Click skills to select. Selected skills: <span className="font-bold text-indigo-600">{formData.skills.length}</span>
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200">
                <label className="block text-xs font-bold text-slate-800 mb-1.5">Add Custom Skill</label>
              ...
              {formData.skills.length > 0 && (
                <div className="pt-3 border-t border-slate-100">
                  <h4 className="text-xs font-bold text-slate-800 mb-2">Selected Skills ({formData.skills.length})</h4>
                  <div className="flex flex-wrap gap-2">
                    {formData.skills.map((s, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-indigo-50 border border-indigo-200 text-indigo-900 text-xs font-medium"
                        >
                          <span>{name}</span>
                          <select
                            value={level}
                            onChange={(e) => updateSkillLevel(name, e.target.value)}
                            className="text-[10px] bg-white border border-indigo-200 rounded px-1 py-0.5 text-indigo-700 outline-none"
                          >
                          ...
                          <button
                            ...
                            className="text-indigo-400 hover:text-indigo-900 ml-0.5"
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </div>
            ...
            >
              <div className="border-b border-slate-100 pb-4 flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-900 font-display">Projects</h2>
                  <p className="text-xs text-slate-500 mt-1">Describe what you built. Simple casual notes are converted by AI into bullet points.</p>
                </div>
                {hasProjects && (
                  <button
                    type="button"
              ...
              {/* Yes / No Toggle */}
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-2">Have you built any projects?</label>
                  ...
                  {formData.projects.map((proj, idx) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-700 mb-1">
                            Technologies Used <span className="text-slate-400 font-normal">(comma-separated)</span>
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="sm:col-span-2">
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-[10px] text-indigo-600 font-medium">✨ Plain language welcome</span>
                          </div>
                          <textarea
            ...
            >
              <div className="border-b border-slate-100 pb-4 flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-900 font-display">Work Experience</h2>
                  <p className="text-xs text-slate-500 mt-1">Internships, full-time, freelance, or contract roles.</p>
                </div>
                {hasExperience && (
                  <button
                    type="button"
              ...
              {/* Yes / No Toggle */}
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-2">Do you have professional experience?</label>
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => {
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 text-xs rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 outline-none disabled:bg-slate-100"
                          />
                        </div>
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-xs font-semibold text-slate-700 mb-1">
                            Achievements & Impact <span className="text-slate-400 font-normal">(Optional)</span>
                          </label>
                          <textarea
            ...
            >
              <div className="border-b border-slate-100 pb-4 flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-900 font-display">Certifications</h2>
                  <p className="text-xs text-slate-500 mt-1">AWS, Google Cloud, Meta, Cisco, or course certificates.</p>
                </div>
                {hasCertifications && (
                  <button
                    type="button"
              ...
              {/* Yes / No Toggle */}
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-2">Do you have any certifications?</label>
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => {
          ...
          {currentStep === 8 && (
            ...
            >
              <div className="border-b border-slate-100 pb-4">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 font-display">Achievements & Extras</h2>
                <p className="text-xs text-slate-500 mt-1">Showcase awards, hackathons, languages, and leadership.</p>
              </div>

              {/* Achievements Section */}
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Honors & Achievements</h3>
                  <div className="flex flex-wrap gap-1">
                    {ACHIEVEMENT_CATEGORIES.slice(0, 4).map((cat) => (
                      <button
                        ...
                        className="px-2.5 py-1 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-[11px] font-semibold rounded-lg transition-colors border border-indigo-200"
                      >
                        + {cat}
                      </button>
                    ))}
                ...
                {formData.achievements && formData.achievements.length > 0 ? (
                  <div className="space-y-3">
                    {formData.achievements.map((ach, idx) => (
                      <div key={ach.id || idx} className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 space-y-2">
                        <div className="flex items-center justify-between">
              ...
              <div className="pt-4 border-t border-slate-100 space-y-4">
                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Optional Profile Sections</h3>
                <div className="space-y-3">
                  {ADDITIONAL_SECTIONS_CONFIG.map((sec) => (
                    <div key={sec.id} className="space-y-1">
                      <label className="block text-xs font-semibold text-slate-700">
                        {sec.label} <span className="text-slate-400 font-normal">(1 item per line)</span>
                      </label>
                      <textarea
          ...
          {currentStep === 9 && (
            ...
            >
              <div className="border-b border-slate-100 pb-4">
                ...
                <h2 className="text-2xl font-extrabold text-slate-900 font-display">Review Your Information</h2>
                <p className="text-xs text-slate-500 mt-1">Review all your entries before AI generates your professional resume.</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs">
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-700 font-medium">{formData.personal.name || 'Not specified'}</p>
                    <p className="text-slate-500">{formData.personal.email}</p>
                    <p className="text-slate-500">{formData.personal.location}</p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-700 font-medium">{formData.career.targetRole || 'Not set'}</p>
                    <p className="text-slate-500">{formData.career.goal} • {formData.career.careerLevel}</p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
                  <div>
                    ...
                    {formData.education.map((e, i) => (
                      <p key={i} className="text-slate-600 truncate">{e.degree || e.qualification} — {e.institution}</p>
                    ))}
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {formData.projects.length > 0 ? (
                      formData.projects.map((p, i) => (
                        <p key={i} className="text-slate-600 truncate">• {p.name}</p>
                      ))
                    ) : (
                  ...
                  <div>
                    ...
                    {formData.experience.length > 0 ? (
                      formData.experience.map((e, i) => (
                        <p key={i} className="text-slate-600 truncate">• {e.jobTitle} at {e.company}</p>
                      ))
                    ) : (
                      <p className="text-slate-400 italic">None</p>
                    )}
        ...
        {currentStep <= 8 && (
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-200/80">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-white border border-slate-200 rounded-xl hover:bg-slate-100 disabled:opacity-30 disabled:pointer-events-none transition-all"
            >
