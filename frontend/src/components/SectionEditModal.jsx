    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Edit manually or refine with AI tone presets</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          {/* AI Preset Toolbar */}
          <div className="px-6 py-3 bg-indigo-50/60 border-b border-indigo-100/60 flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              <button
                ...
                className="px-2.5 py-1 text-xs font-medium bg-white hover:bg-indigo-600 hover:text-white text-indigo-700 rounded-lg border border-indigo-200 transition-all shadow-sm disabled:opacity-50 flex items-center gap-1"
              >
          ...
          <div className="p-6 flex-1 overflow-y-auto">
            ...
            <div className="relative">
              <textarea
                ...
                rows={6}
                className={`w-full p-3.5 text-sm text-slate-800 bg-white border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all resize-y ${
                  isEnhancing ? 'opacity-50 pointer-events-none' : 'border-slate-300'
                }`}
                placeholder="Enter text..."
              />
              {isEnhancing && (
                <div className="absolute inset-0 flex items-center justify-center bg-white/70 backdrop-blur-xs rounded-xl">
                  <div className="flex items-center gap-2 text-indigo-700 font-semibold text-xs animate-pulse">
